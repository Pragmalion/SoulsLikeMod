            ...
            if (hitResult.getType() == HitResult.Type.BLOCK) {
                ...
                if (world instanceof ServerLevel) {
                    ...
                    for (int i = 0; i < particleCount; i++) {
                        ...
                        serverLevel.sendParticles(ParticleTypes.FLAME, x, y, z, 0, 0, 0, 0, 5000); // установили длительность частиц
                    }
                    ...
                    explosion.explode();
                    serverLevel.playSound(null, hitPos, SoundEvents.GENERIC_EXPLODE, SoundSource.BLOCKS, 20.0f, 20.0f);
                }
